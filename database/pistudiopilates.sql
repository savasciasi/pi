...
(1, 'Pi Studio Pilates', 'Vücudunu güçlendir, nefesinle ak.', 'Deneme Dersi Al', 'Ders Programı', '#contact', '#schedule', 'Bağdat Caddesi No:123, İstanbul', '', NULL);
...
('Cadillac', 'Çok yönlü egzersiz seçenekleri sunar.', 'Cadillac ile kuvvet, esneklik ve koordinasyon birlikte geliştirilir.', NULL, 4),
('Chair', 'Denge ve güç odaklı kompakt ekipman.', 'Chair egzersizleri özellikle core ve alt beden stabilitesini artırır.', NULL, 5),
('Barrel', 'Omurga mobilitesi ve esneklik için ideal.', 'Barrel dersleri postürü iyileştirir ve omurga esnekliğini destekler.', NULL, 6);
