...
<header class="hero" style="background-image: url('<?= htmlspecialchars(media_url($hero['background_media'] ?? null)); ?>');">
    <div class="container text-center py-5">
        ...
        <div class="d-flex flex-column flex-md-row align-items-center justify-content-center gap-3">
            <a class="btn btn-primary btn-lg" href="<?= htmlspecialchars($hero['cta_primary_link'] ?? '#contact'); ?>"><?= htmlspecialchars($hero['cta_primary_text'] ?? 'Deneme Dersi Al'); ?></a>
            <a class="btn btn-outline-light btn-lg" href="<?= htmlspecialchars($hero['cta_secondary_link'] ?? '#schedule'); ?>"><?= htmlspecialchars($hero['cta_secondary_text'] ?? 'Ders Programı'); ?></a>
        </div>
    </div>
</header>
...
<main>
                    ...
                    <div class="col">
                        <article class="card h-100">
                            <?php if (!empty($equipment['img'])): ?>
                                <img src="<?= htmlspecialchars(media_url($equipment['img'])); ?>" class="card-img-top" alt="<?= htmlspecialchars($equipment['title']); ?>">
                            <?php endif; ?>
    ...
    <section id="history" class="section-spacer bg-white">
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-lg-8">
            ...
            <div class="row g-5 align-items-center">
                <div class="col-lg-5">
                    <?php if (!empty($instructor['photo'])): ?>
                        <img src="<?= htmlspecialchars(media_url($instructor['photo'])); ?>" class="instructor-photo" alt="Pınar Sarı Koçak">
                    <?php else: ?>
                        <img src="<?= htmlspecialchars(PLACEHOLDER_IMG); ?>" class="instructor-photo" alt="Pınar Sarı Koçak">
                    <?php endif; ?>
                </div>
                <div class="col-lg-7">
                            ...
                            <?php foreach (explode("\n", $instructor['highlights']) as $highlight): ?>
                                ...
                                <div class="col">
                                    <div class="d-flex align-items-start gap-2">
                                        <span class="badge text-uppercase">Uzmanlık</span>
        ...
        <div class="container">
            <div class="row align-items-center mb-4">
                ...
                <div class="col-lg-6 text-lg-end text-muted">
                    <p class="section-lead mb-0">Pınar Sarı Koçak&#39;ın tamamladığı ve devam eden eğitimler, öğrencilerimizin güvenli ve etkili bir deneyim yaşamasını sağlar.</p>
                </div>
            </div>
            <div class="row row-cols-1 row-cols-md-2 row-cols-xl-3 g-4">
                    ...
                    <div class="col">
                        <article class="card h-100">
                            <?php if (!empty($training['img'])): ?>
                                <img src="<?= htmlspecialchars(media_url($training['img'])); ?>" class="card-img-top" alt="<?= htmlspecialchars($training['title']); ?>">
                            <?php endif; ?>
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                    <h3 class="h5 mb-0"><?= htmlspecialchars($training['title']); ?></h3>
